...
- grote kratten voor **12** flessen;
- middelgrote kratten voor **6** flessen;
- kleine kratten voor **4** flessen.
...
- hoeveel kratten van **12** flessen nodig zijn;
- hoeveel kratten van **6** flessen nodig zijn;
- hoeveel kratten van **4** flessen nodig zijn;
- hoeveel flessen er **overschieten** (die niet in een krat passen).

...
ntests= 30
sex = ["man","vrouw"]
cases = [("man",95.1,98.2), ("man",95.1,95.1),("man",94.0,100.0), ("vrouw",0.80,100.0), ("vrouw",0.90,100.0)]
while len(cases) < ntests:
    g = random.choice(sex)
    t = round(random.uniform(75,120), 1)
    h = round(random.uniform(75,120), 1)
    
    if (g,t,h) not in cases:
        cases.append( (g,t,h) )

...
# generate test data
ntests= 20
namen = ["Sebastiaan", "David", "Xavier", "Jacobus", "Jozef", "Lorenzo", "Pierre"]
cases = [("Markus", 30, 24) ]
while len(cases) < ntests:
    naam = random.choice(namen)
    lengte1 = random.randint(24,40)
    lengte2 = random.randint(1,lengte1)
    cases.append( (naam, lengte1, lengte2) )

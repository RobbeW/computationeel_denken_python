...
print("De oppervlakte van vierkant PQRS is", oppervlakte_pqrs_afgerond, "vierkante meter.")
print("De lengte van een zijde van vierkant PQRS is", zijde_pqrs_afgerond, "meter.")

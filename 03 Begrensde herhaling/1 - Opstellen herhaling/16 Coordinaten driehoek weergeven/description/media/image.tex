...
\begin{document}
	\begin{tikzpicture}[font=\small, tl/.style = {black, inner sep=1pt, font=\scriptsize} ]
		...
		\draw[black!50, semitransparent, thick] (-0.125,0) to[bend right=50] (0,-0.125) -- (1, -.125) to[out=0, in=-45,looseness=1.7] (1.1,0.125) to ++(135:1.3) to[out=135, in=90, looseness=1.7] (-0.125,1) -- cycle;
		% grid
